...
<title>AmoX</title>
<meta charset="utf-8">
<meta name="keywords" content="AmoX, Discord">
...
<body>
<img src="/img/graphics/landing/amox-main." width="1" height="1" alt="preload"/>
...
<div class="page-con-content landing-con-override">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
								...
								<div class="build-btn-button">
									<div class="build-ico-button">
										<div class="build-ico-os">
											<img src="img/icons/os/amox.png" style='height: 100%; width: 100%; object-fit: contain'/>
											<img src="img/icons/os/amox.png" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
											<img src="img/icons/os/amox.png" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
										</div>
									</div>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/amox-main.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 Нужна помощь?<b>
									 Заходи на наш сервер поддержки бота, там мы всегда поможем тебе!<b>
									 Нажимай на кнопку ниже!
								</p>
							</div>
							<a href="https://discord.gg/RxCtgWAYdX" target="_blank">
	...
	<div class="landing-con-adsense">
		<div class='adsense-tx1-description darkmode-txt'>
			<span>Тут могла быть реклама, но я её не сделаю =)</span>
		</div>
